  ...
  <div>
    ...
    <el-table :data="tableData" style="width: 100%" row-key="id">
      ...
      <!-- 列表 
        prop 指定渲染的数据对象 key
      -->
      <el-table-column label="昵称" width="180" prop="uid"></el-table-column>
      <el-table-column label="手机号" width="180" prop="rolename"></el-table-column>
      <el-table-column label="注册日前" width="180" prop="username"></el-table-column>
    ...
    <el-dialog :title="isAdd?'新增管理员':'编辑管理员'" :visible.sync="isShow" @open="openFn" @close="closeFn">
      <!-- 表单 -->
...
export default {
  ...
  methods: {
    ...
    async handleDelete(row) {
      try {
        // 提示删除操作是否进行
        await this.$confirm("此操作将删除该角色, 是否继续?", "", {
